...
from GraviPy.Integrators import euler
from  GraviPy.Collisions.ParticleParticleCollision import ParticleParticleCollision
...
class Environment():
    ...
    def __init__(self, particles=[], bodies=[], forces=[], spring_links=[], collision_resolvers=[], time=0, dt=0.01, dimensions=3, integrator=euler) -> None:
        ...
        print("Welcome to the GraviPy Environment Version {self.__version__}")
    ...
    def set_integrator(self, integrator):
        ...
        Parameters:
            integrator (Integrator): The integrator to be set from GraviPy.Integrators.
    ...
    def add_force(self, force, name=None):
        ...
        Parameters:
            force (Force): The force to be added to the environment. These are objects that are either already provided in the GraviPy.Forces folder
    ...
    def add_spring(self, softening_length=0, active=True, name=None):
        from GraviPy.Forces.spring import Spring
    ...
    def add_uniform_force_field(self, F=[0,-981,0], active=True, name=None):
        ...
        """
        from GraviPy.Forces.uniform_force_field import UniformForceField
    ...
    def add_uniform_acceleration_field(self, a=[0,-9.81,0], active=True, name=None):
        ...
        None
        """
        from GraviPy.Forces.uniform_acceleration_field import UniformAccelerationField
    ...
    def add_gravity(self, G= 6.67430e-11, softening_length=0, active=True, name=None):
        from GraviPy.Forces.gravity import Gravity
    ...
    def add_coulomb(self, k=8.9875517873681764e9, active=True, name=None):
        from GraviPy.Forces.coulomb import Coulomb
    ...
    def add_drag(self, active=True, name=None):
        ...
        Returns:
            None
        """
        from GraviPy.Forces.drag import Drag
    ...
    #     from GraviPy.Forces.gravityKDtree import GravityKDTree
    ...
    def add_field(self, field_function, active=True, name=None, **kwargs): 
        ...
        """
        from GraviPy.Forces.custom_field import CustomField
